/*
	Для работы модуля:
		...
		* Обернуть форму в div c атрибутом ng-controller="authCtrl as authCtrl"
		* Присвоить input атрибут ng-model
		* Присвоить форме ng-submit="authCtrl.submit(user, formName, '/path-to'), где user - массив из данных input, formName - имя формы, '/path-to' - путь запроса
